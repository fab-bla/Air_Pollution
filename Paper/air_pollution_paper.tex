...
As a robustness check of our results, we used a feasible generalized least square model. 

<<<<<<< Updated upstream
=======
%OLS model as a robustness check
...
\begin{table}[!htbp] \centering 
	\caption{Results FGLS \& SLX}\label{TableRes}
	\label{} 
