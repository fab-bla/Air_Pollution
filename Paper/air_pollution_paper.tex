...
%	\end{center}
	...
	Not only cardiovascular diseases can be enhanced or even caused by air pollution. \hl{Kim, et al. (2018)} %quelle
...
Depending on which social insurance system a patient is covered - more on this in the section \ref{orga} - outpatient stays are partially covered. In general chronic diseases are partly covered by public expenditures. And so environmental pollution affects the public budget of health care. 
	...
	%In this chapter discusses the structure of the Chinese health care system in more detail. To be more specific, firstly the system by which social services (of any kind) are determined, namely the hukou or huji system will bewe presented in more detail. After that, the structure of the system will be discussed in more detail, as well as the services  provided to the individual. 
	...
	The hukou system is the official residence registration system on household level in China, where each individual is assigned a permanent residence.
	...
	However, this changed in 1955. There was a strong influx of farmers into the cities. In response to the government, the hukou was expanded to also include rural regions.  
