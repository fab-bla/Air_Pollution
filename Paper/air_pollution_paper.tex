...
In 2019 the major premature death causes in China were cardiovascular diseases totaling 43 percent, followed by malignant neoplasms (26 percent), respiratory diseases (10 percent), unintentional injuries (6 percent) and neurological conditions (4 percent). Other conditions that accounted for between 3 and 1 percent of premature deaths, in descending order, were digestive diseases, genitourinary diseases, respiratory infections, diabetes mellitus and infectious and parasitic diseases. \par %https://www.who.int/data/gho/data/themes/mortality-and-global-health-estimates/ghe-leading-causes-of-death
Thus air pollution has its consequences and these are reflected in the health of the population. With increasing health impairments of the population, costs of the public health system are rising. 
...
Inspired by the paper of x and y with the title "blablabla", we want to set up a regional analysis of our own that analyzes the effect between air pollution and public health expenditures. Our research question is as follows: 

"\textit{To what extent does air pollution and its spatial spillover effects influence
